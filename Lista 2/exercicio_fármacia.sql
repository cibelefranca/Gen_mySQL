...
INSERT INTO tb_produtos (nome, dataCadastro, quantidade, preco, categoria_id) VALUES ("Shampoo Salon Line", current_date(), 150, 26.50, 3);
INSERT INTO tb_produtos (nome, dataCadastro, quantidade, preco, categoria_id) VALUES ("Neusaldina", current_date(), 200, 20.00, 2);
INSERT INTO tb_produtos (nome, dataCadastro, quantidade, preco, categoria_id) VALUES ("Esponja de Banho", current_date(), 200, 15.90, 3);
INSERT INTO tb_produtos (nome, dataCadastro, quantidade, preco, categoria_id) VALUES ("TNT", current_date(), 40, 10.90, 5);
INSERT INTO tb_produtos (nome, dataCadastro, quantidade, preco, categoria_id) VALUES ("Rímel Boca Rosa", current_date(), 30, 45.50, 4);
